...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'ECEAuthBundle' => 'ECE\\Bundle\\AuthBundle\\ECEAuthBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'wireless',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'de88bbbf96e3cc50b2e209271de3c08387d4536c',
            ...
            'kernel.secret' => 'de88bbbf96e3cc50b2e209271de3c08387d4536c',
            ...
            'fos_user.model.user.class' => 'ECE\\Bundle\\AuthBundle\\Entity\\User',
        ...
        $this->methodMap = array(
            ...
            'faker.entities.0.formatters.4' => 'getFaker_Entities_0_Formatters_4Service',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'wireless', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array((dirname(dirname(dirname(__DIR__))).'/src/ECE/Bundle/AuthBundle/Resources/config/doctrine') => 'ECE\\Bundle\\AuthBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine') => 'FOS\\UserBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($a, 'ECE\\Bundle\\AuthBundle\\Entity');
        $c->addDriver($b, 'FOS\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('ECEAuthBundle' => 'ECE\\Bundle\\AuthBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ef0458ba28d391e4970d824cc9f8138cf06410abb6e4513e72af1272af65466c');
    ...
    {
        return $this->services['faker.entities.0.formatters.0'] = $this->get('faker.formatter_factory')->createClosure($this->get('faker.generator'), 'word', array(), false, NULL);
    }
    ...
    {
        return $this->services['faker.entities.0.formatters.1'] = $this->get('faker.formatter_factory')->createClosure($this->get('faker.generator'), 'randomElement', array(0 => array(0 => 'pass1', 1 => 'pass2', 2 => 'pass3')), false, NULL);
    }
    ...
    {
        return $this->services['faker.entities.0.formatters.2'] = $this->get('faker.formatter_factory')->createClosure($this->get('faker.generator'), 'randomElement', array(0 => array(0 => 1, 1 => 1)), false, NULL);
    }
    ...
    {
        return $this->services['faker.entities.0.formatters.3'] = $this->get('faker.formatter_factory')->createClosure($this->get('faker.generator'), 'randomElement', array(0 => array(0 => 0, 1 => 0)), false, NULL);
    }

    /**
     * Gets the 'faker.entities.0.formatters.4' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \closure A closure instance.
     */
    protected function getFaker_Entities_0_Formatters_4Service()
    {
        return $this->services['faker.entities.0.formatters.4'] = $this->get('faker.formatter_factory')->createClosure($this->get('faker.generator'), 'randomElement', array(0 => array(0 => 0, 1 => 0)), false, NULL);
    }
    ...
    {
        return $this->services['faker.entities.0.metadata'] = $this->get('doctrine.orm.default_entity_manager')->getClassMetadata('ECE\\Bundle\\AuthBundle\\Entity\\User');
    }
    ...
    protected function getFaker_PopulatorService()
    {
        ...
        $instance->addEntity($this->get('faker.entities.0'), 2, array('username' => $this->get('faker.entities.0.formatters.0'), 'password' => $this->get('faker.entities.0.formatters.1'), 'enabled' => $this->get('faker.entities.0.formatters.2'), 'expired' => $this->get('faker.entities.0.formatters.3'), 'locked' => $this->get('faker.entities.0.formatters.4'), 'expires_at' => NULL, 'confirmation_token' => NULL, 'password_requested_at' => NULL, 'credentials_expire_at' => NULL), array(), false);
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('ECE\\Bundle\\AuthBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('ECE\\Bundle\\AuthBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'ECE\\Bundle\\AuthBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, $h, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '54a82806c9b83', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/ECE/Bundle/AuthBundle/Resources/views'), 'ECEAuth');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('de88bbbf96e3cc50b2e209271de3c08387d4536c');
    }
